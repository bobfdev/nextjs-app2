...
async function getStaticPaths() {
  const client = await external_mongodb_["MongoClient"].connect('mongodb+srv://bob:s56vPfSrEZDh21vR@cluster0.rruev.mongodb.net/meetups?retryWrites=true&w=majority');
  const db = client.db();
